...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Book House Cleaning Online v2`}</title>

        <meta
          name="description"
          content="Welcome to Book House Cleaning Online v2 - Making your house clean and shiny with our professional full home deep cleaning services"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1563453392212-326f5e854473?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjbGVhbmluZ3xlbnwwfHx8fDE2OTc0NjQ4NTd8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Book House Cleaning Online v2`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Book House Cleaning Online v2 - Making your house clean and shiny with our professional full home deep cleaning services`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Cleaning Staff" type="cleaning-staff" abilities={appConfig.ownerAbilities} />
